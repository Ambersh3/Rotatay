...
namespace Rotatay
{
    public partial class MainFrm : Form
    {
        ...
        {
            Display.Rotate((uint)ScreenInt.Value, Display.Orientations.DEGREES_CW_180);
        }

        private void StopRotateBtn_Click(object sender, EventArgs e)
        {
            Display.Rotate((uint)ScreenInt.Value, Display.Orientations.DEGREES_CW_0);
        }

        private void ScreenInt_ValueChanged(object sender, EventArgs e)
        {
            try
            {
                Properties.Settings.Default.Screen = ScreenInt.Value;
        ...
        private void MainFrm_Load(object sender, EventArgs e)
        {
            try
            {
                ScreenInt.Value = Properties.Settings.Default.Screen;
            }
            catch { }
        }
    }
